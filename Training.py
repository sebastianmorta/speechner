...
if __name__ == "__main__":
    ...
    for model, eval in zip(models, evaluators):
        training_args = TrainingArguments(
            output_dir=f"./TrainResult{model.model_name}",
        ...
        torch.save(model.state_dict(),f'./TorchResult/{model.model_name}.pth')
        model.save_pretrained(f'./FromPretrainedResult/{model.model_name}')
